...
class NoteSyncApiControllerTest {
    ...
    void shouldOverwriteInternalNotes() throws Exception {
        ...
        assertThat(notesDb.getFirst().contentsModificationTime).isEqualTo(Instant.parse("2011-11-11T11:11:11Z"));
        ...
        assertThat(removedNotesDb.getFirst().removalTime).isEqualTo(Instant.parse("2011-11-11T11:11:11Z"));
    ...
    private Note newNote(UUID id, UUID userId, String title, String content, Instant contentsModificationTime) {
        try {
    ...
    private RemovedNote newRemovedNote(UUID id, UUID userId, Instant contentsModificationTime) {
        try {
